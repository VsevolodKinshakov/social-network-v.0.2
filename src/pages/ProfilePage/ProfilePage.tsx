...
import { ProfileUserBlock } from "../../components/ProfileUserBlock/ProfileUserBlock";
    ...
    <LayoutContainer>
      <div className="ProfilePage">
        ...
        <aside className="RightSide">
          <Bio />
          <FriendsList mainText="Друзья" secondaryText="130" />
          <MusicBlock mainText="Моя музыка" secondaryText="458" />
        </aside>
      </div>
    </LayoutContainer>
  );
